...
Park folder for scripts and records already written, so they are not lost
in directory flow.

**Repo:** `WSP001/ROBORTO-DBA-WSP` (public)
**Purpose:** Commons-Good teammate-readable record
...
| File | Job |
|---|---|
| [REPO-MAP.md](./REPO-MAP.md) | Every WSP001 repo, business vs social, public vs private |
| [FIT-PLAN.md](./FIT-PLAN.md) | Where HQ / TAMMY code fits. What this commit is. What waits. |
...
- The live HQ app source tree
- Private graph (lots, AIS, buyers, COC)
- Exact private repository / ref / SHA (public subject stays UNKNOWN)
